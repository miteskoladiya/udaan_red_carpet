  ...
  return (
    (<CarouselContext.Provider value={{ onCardClose: handleCardClose, currentIndex }}>
      <div className="relative  w-full">
        <div
          className="flex w-full overflow-x-scroll overscroll-x-auto py-10 md:py-20 scroll-smooth [scrollbar-width:none] justify-center  "
          ref={carouselRef}
      ...
      {open && (
        <div className="fixed inset-0 h-screen z-50 overflow-auto">
          ...
          <motion.div
            ...
            className="max-w-xl mx-auto bg-white dark:bg-neutral-900 h-fit  z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative">
            <button
